Contributing to EXCL Core
============================

The EXCL Core project operates an open contributor model where anyone is
...
The following applies to code changes to the EXCL Core project, and is not to be
confused with overall EXCL Network Protocol consensus changes.

Whether a pull request is merged into EXCL Core rests with the project merge
...
Patches that change EXCL consensus rules are considerably more involved than
...
Where a patch set proposes to change the EXCL consensus, it must have been
...
The project leader is the release manager for each EXCL Core release.
