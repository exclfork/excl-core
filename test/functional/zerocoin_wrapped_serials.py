#!/usr/bin/env python3
# Copyright (c) 2019 The EXCL Core developers
...
from fake_stake.base_test import EXCL_FakeStakeTest

class zEXCLwrappedSerialsTest(EXCL_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zEXCLs..." % DENOM_TO_USE)
