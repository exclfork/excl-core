...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EXCL features */
        {"excl", "masternode", &masternode, true, true, false},
        {"excl", "listmasternodes", &listmasternodes, true, true, false},
        {"excl", "getmasternodecount", &getmasternodecount, true, true, false},
        {"excl", "masternodeconnect", &masternodeconnect, true, true, false},
        {"excl", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"excl", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"excl", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"excl", "masternodecurrent", &masternodecurrent, true, true, false},
        {"excl", "masternodedebug", &masternodedebug, true, true, false},
        {"excl", "startmasternode", &startmasternode, true, true, false},
        {"excl", "createmasternodekey", &createmasternodekey, true, true, false},
        {"excl", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"excl", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"excl", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"excl", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"excl", "getmasternodescores", &getmasternodescores, true, true, false},
        {"excl", "mnbudget", &mnbudget, true, true, false},
        {"excl", "preparebudget", &preparebudget, true, true, false},
        {"excl", "submitbudget", &submitbudget, true, true, false},
        {"excl", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"excl", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"excl", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"excl", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"excl", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"excl", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"excl", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"excl", "checkbudgets", &checkbudgets, true, true, false},
        {"excl", "mnsync", &mnsync, true, true, false},
        {"excl", "spork", &spork, true, true, false},
        {"excl", "getpoolinfo", &getpoolinfo, true, true, false},
...
//        {"zerocoin", "getzexclseed", &getzexclseed, false, false, true},
//        {"zerocoin", "setzexclseed", &setzexclseed, false, false, true},
//        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
//        {"zerocoin", "searchdzexcl", &searchdzexcl, false, false, true},
//        {"zerocoin", "dzexclstate", &dzexclstate, false, false, true},
...
{
    return "> excl-cli " + methodname + " " + args + "\n";
}
