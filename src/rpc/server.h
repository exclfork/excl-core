...
//extern UniValue setzexclseed(const UniValue& params, bool fHelp);
//extern UniValue getzexclseed(const UniValue& params, bool fHelp);
//extern UniValue generatemintlist(const UniValue& params, bool fHelp);
//extern UniValue searchdzexcl(const UniValue& params, bool fHelp);
//extern UniValue dzexclstate(const UniValue& params, bool fHelp);
