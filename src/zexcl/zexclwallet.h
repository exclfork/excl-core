...
#ifndef EXCL_ZEXCLWALLET_H
#define EXCL_ZEXCLWALLET_H
...
public:
    CzEXCLWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZEXCL(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZEXCL(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
