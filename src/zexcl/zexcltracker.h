...
#ifndef EXCL_ZEXCLTRACKER_H
#define EXCL_ZEXCLTRACKER_H
...
public:
    CzEXCLTracker(std::string strWalletFile);
    ~CzEXCLTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzEXCLWallet* zEXCLWallet = NULL);
