                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzEXCLPathCustom = GetArg("-zexclbackuppath", "");
    ...
    if(!strzEXCLPathCustom.empty()) {
        ui->wallet_customzexclbackuppath->setText(QString::fromStdString(strzEXCLPathCustom));
        ui->wallet_customzexclbackuppath_label->setVisible(true);
        ui->wallet_customzexclbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzEXCLPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the EXCL RPC console.") + "<br>" +
