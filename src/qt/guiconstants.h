...
/* Excl GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "EXCL"
#define QAPP_ORG_DOMAIN "excl.org"
#define QAPP_APP_NAME_DEFAULT "EXCL-Qt"
#define QAPP_APP_NAME_TESTNET "EXCL-Qt-testnet"
