...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // EXCL: 1 day
        nTargetSpacing = 1 * 60;  // EXCL: 1 minute
        nMaturity = 100;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "SEC Crypto Czar: Platforms Listing IEOs May Face Regulatory Trouble";
        ...
        strSporkKey = "04be3b88eae4b6c6c1a1eeafc934a361229758e6fdc0ee1f2d8be9ce4fa8df79944cd2c86fe4c8199cae45d230313003464e14024cfbcf9063a3422419fd8e7b7c";
        strSporkKeyOld = "04B433E6598390C992F4F022F20D3B4CBBE691652EE7C48243B81701CBDB7CC7D7BF0EE09E154E6FCBF2043D65AF4E9E97B89B5DBAF830D83B9B7F469A6C45A717";
        strObfuscationPoolDummyAddress = "EV3pnsexEyBtNUMut8dV1KRNfHtJf6YbmR";
        nStartMasternodePayments = 1559174400; // Thu, 30 May 2019 00:00:00 GMT for mainnet
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zexcl to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("04dd24ab003c828cdd9cf4db2ebbde8e1cecb3bbfa8b3127fcb9dd9b84d44112080827ed7c49a648af9fe788ff42e316aee665879c553f099e55299d6b54edd7e0");
        nDefaultPort = 24230;
        ...
        genesis.nNonce = 1311690;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("000018ed70e2e0b9522c8528f5d21476184853981a2c9897e91c8090ccf90b2a"));
        ...
        // Testnet excl BIP44 coin type is '1' (All coin's testnet default)
        ...
        strSporkKey = "04D244288A8C6EBBF491443EBFA1207275D71CB009F201C118B00CF8E77641C7F1E63E330BA909842C009AF375C0F5C1C7368E8D7E2066168C40CE3CB629CF212F";
        strSporkKeyOld = "04348C2F50F90267E64FACC65BFDC9D0EB147D090872FB97ABAE92E9A36E6CA60983E28E741F8E7277B11A7479B626AC115BA31463AC48178A5075C5A9319D4A38";
        strObfuscationPoolDummyAddress = "y57cqfGRkekRyDRNeJiLtYVEbvhXrNbmox";
        nStartMasternodePayments = 1556668800; //  Wed, 01 May 2019 00:00:00 GMT for testnet
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // EXCL: 1 day
        nTargetSpacing = 1 * 60;        // EXCL: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        nLastPOWBlock = 250;
        nMaturity = 100;
        nMasternodeCountDrift = 4;
        ...
        genesis.nTime = 1554132731;
        genesis.nNonce = 260366;

//        assert(hashGenesisBlock == uint256("00000988b0b44289daea71f040612991b9b5c8ad8bd8282d5970ab9f6a410500"));
