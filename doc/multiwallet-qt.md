...
In order to support loading of multiple wallets in excl-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is excl.cpp.
...
Changes to excl.cpp
----------------------
excl.cpp is the entry point into excl-qt, and as such, will require some minor modifications to provide hooks for
