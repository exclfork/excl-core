...
This means one can have an always-on excld instance running, and another local excld/excl-qt instance which connects to this node and receives blocks from it.
