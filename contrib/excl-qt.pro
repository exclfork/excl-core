...
RESOURCES += src/qt/excl.qrc src/qt/excl_locale.qrc

TRANSLATIONS += src/qt/locale/excl_bg.ts \
                src/qt/locale/excl_de.ts \
                src/qt/locale/excl_en.ts \
                src/qt/locale/excl_es.ts \
                src/qt/locale/excl_fi.ts \
                src/qt/locale/excl_fr.ts \
                src/qt/locale/excl_it.ts \
                src/qt/locale/excl_ja.ts \
                src/qt/locale/excl_pl.ts \
                src/qt/locale/excl_pt.ts \
                src/qt/locale/excl_ru.ts \
                src/qt/locale/excl_sk.ts \
                src/qt/locale/excl_sv.ts \
                src/qt/locale/excl_vi.ts \
                src/qt/locale/excl_zh_CN.ts \
                src/qt/locale/excl_zh_TW.ts
